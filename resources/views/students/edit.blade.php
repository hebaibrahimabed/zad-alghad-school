        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">نموذج تعديل بيانات الطالب: {{ $student->full_name }}</h3>
                ...
                <form action="{{ route('students.update', $student->IDNumber) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        @if($errors->any())
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="IDNumber" id="IDNumber"
                                           ...
                                           value="{{ old('IDNumber', $student->IDNumber) }}" readonly>
                                    @error('IDNumber')
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="dateOfBirth" id="dateOfBirth"
                                           ...
                                           value="{{ old('dateOfBirth', $student->dateOfBirth->format('Y-m-d')) }}" required>
                                    @error('dateOfBirth')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="registrationDate" id="registrationDate"
                                           ...
                                           value="{{ old('registrationDate', $student->registrationDate->format('Y-m-d')) }}" required>
